...
| table-column-config     | [[]table.CloumnConfig][column config documentation] | Customize columns based on the underlying column config struct[^1]                                                                            | table-column-config = { summary = { widthmax = 40 } } |                                                                                  |
